...
CREATE TABLE IF NOT EXISTS `companies` (
  ...
  `ubicacion_geografica` JSON,
  `representantes_ventas` JSON,
  `descripcion_empresa` TEXT,
  `galeria_productos_urls` JSON,
  `categories_ids` JSON,
  `redes_sociales` JSON,
